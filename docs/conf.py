...
linkcheck_ignore = [
    ...
    "https://github.com/joe-cho/the-littlest-jupyterhub/pull/",  # too many PRs in changelog
    "https://github.com/joe-cho/the-littlest-jupyterhub/compare/",  # too many comparisons in changelog
]
